const menuHTML = `
  ...
  <a href="juguetes-gatos_perros.html" class="nav-link">Juguetes Perros y Gatos</a>
  <a href="accesorios-perros_gatos.html" class="nav-link">Accesorios Perros y Gatos</a>
`;
